  ...
  var loadingCreate = function (loadingType, messageOrOptions, options, display, delay) {
    ...
    if (display) {
      ...
      if (loadingType === typesLoading.Standard) {
        ...
        svgIcon = loadingAndBlockSvgIconNotiflix(newLoadingSettings.svgSize, '#f8f8f8', '#6A9512');
      }
